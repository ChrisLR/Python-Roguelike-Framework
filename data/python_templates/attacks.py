...
punch_template = UnarmedAttackTemplate(
    ...
    message="{attacker} throw {attacker_his} fist at {defender}",
    requirements=[
...
slash_template = MeleeAttackTemplate(
    ...
    message="{attacker} slash {attacker_weapon} at {defender}",
...
smash_template = MeleeAttackTemplate(
    ...
    message="{attacker} smash {attacker_weapon} at {defender}",
...
stab_template = MeleeAttackTemplate(
    ...
    message="{attacker} stab {attacker_weapon} at {defender}",
