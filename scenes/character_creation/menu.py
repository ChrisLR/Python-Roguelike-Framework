...
class CharacterCreationMenu(cocos.menu.Menu):
    def __init__(self, title, class_templates, race_templates):
        ...
        self.create_menu([
            cocos.menu.EntryMenuItem('Name:', callback_func=self.set_name, value='Default', max_length=20),
            cocos.menu.MenuItem('Start', callback_func=lambda: director.pop()),
    ...
    def _generate_title(self):
        ...
        fo = pyglet.font.load(self.font_title['font_name'], self.font_title['font_size'])
